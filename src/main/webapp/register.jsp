...
<div class="banner">
    <div class="wrapper">
        ...
        <div class="login">
            ...
            <img src="static/images/registerfont.png" alt="">
            ...
            <form action="register" method="post">
                ...
                <!-- 登录按钮 -->
                <input type="submit" value="注&nbsp;&nbsp;&nbsp;册" class="butt" />
                <!-- <a href="#">登&nbsp;&nbsp;&nbsp;录</a> -->

                <!-- 输入错误tip -->
                <c:if test="${failure}">
                    <p class="alltip">用户名已存在，请重新注册</p>
                </c:if>
            ...
            <!-- 转登录 -->
            <a href="/eebookhouse/login" class="go">已有账号？登录!</a>
